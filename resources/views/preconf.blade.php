	...
	<div class="row">
		<div class="col-md-12">
			...
			<ol>
				...
				<li>Acara akan dimulai dari 08:30 - 17:30.</li>
				<li>Penyelenggara diharapkan untuk memungut biaya dari peserta dengan biaya minimal Rp. 200,000,-</li>
				<li>Biaya digunakan untuk menutup biaya transportasi dan akomodasi fasilitator workshop dari Jakarta/Bandung ke kota yang bersangkutan.</li>
				...
				<li>Sisa pemasukan dikembalikan ke komunitas lokal untuk memajukan kegiatan Scrum di kota tersebut.</li>
				<li>Apabila acara membutuhkan sponsor, maka penyelenggara yang bertanggung-jawab untuk mencari sponsor.</li>
