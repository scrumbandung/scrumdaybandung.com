...
Scrum Day Bandung is a perfect place to be for leaders, managers and change agents who have concerns about business agility and profesionalism in software development ecosystem to meet, exchange experiences and support each other. Unlike other conferences in the region where participants only leave the event with information or knowledge, in this event participants will feel inspired and empowered to make changes in their respective companies knowing that others will walk alongside them. 
                ...
                <p>
This event is an exclusive event for managers and business leaders. This event will be the first business agility &amp; modern management conference with Scrum in Indonesia. If you share our mission for an software development ecosystem that emphasizes agility and professionalism, join the movement and attend this 1-day annual event. We would like to meet and interact with you at the event.                  
                </p>
        </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="tab_1">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <p>
                                Free introduction to Scrum Training limited to 30 persons who have registered for the conference.
                            </p>
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item">
                                <b>Talks</b>
                                <p>
                                    Inspring talks for business leaders to lead their companies with a more relevant management model for 21st centuries situation from other radical thought leaders. The topics that are presented during talks sessions are mainly Scrum at strategic level.
                                </p>
                            </li>
                            <li class="list-group-item">
                                <b>Coaches corner</b>
